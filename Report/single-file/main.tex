...
% TODO
% dane autora
\newcommand{\FirstNameAuthor}{Michal}
\newcommand{\SurnameAuthor}{Lubczynski}
...
\newcommand{\SurnameCoauthor}{Zagorski}   % Jeżeli praca ma tylko jednego autora, to dane drugiego autora zostają puste.
...
\newcommand{\Supervisor}{Dr. Inz. Aleksander Iwaniak}     % dane promotora (bez $\langle$ i $\rangle$)
...
Celem pracy jest stworzenie oprogramowania wraz ze stanowiskiem roboczym do przechwytywania danych z modulu kamery termowizyjnej o modelu MLX 90640.
